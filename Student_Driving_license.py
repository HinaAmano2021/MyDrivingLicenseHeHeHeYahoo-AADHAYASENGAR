...
label_variable = Label(root)


# Define the function
def update();
    id_tim = 20250407016
    id_name = "Aadhaya Sengar"
    id_vehicle = "Two wheeler"
    id_dob = "7th January 2009"
    id_pin = 370405
    id_adress = "Mundra, Kutch Destrict, Gujarat, India, Asia, Earth..."
    
    
# Create a button
button1 = Button(root,text="Show my Driving License", command=update)


button1.configure(width = 50 , activebackground = "pink", relief= FLAT)
